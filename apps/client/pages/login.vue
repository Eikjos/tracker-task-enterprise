<template>
  <div class="flex">
    ...
    <form @submit="onSubmit" class="w-1/3 border-l-2 border-input px-10 flex flex-col gap-2 h-screen bg-white"  >
      ...
      <span class="text-xs">Mot de passe oublié ? <a class="cursor-pointer text-gray-700">Modifiez-le</a></span>
